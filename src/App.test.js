...
test('App grabs the show data and renders to the page', async () => {
    ...
    await wait (() => {
       getByText(/A love letter to the '80s classics that captivated a generation/i); 
    });
    expect(getByText(/A love letter to the '80s classics that captivated a generation/i)).toBeInTheDocument();
